...
const EXTRA_PAGE_COPY = {
  ...
  "ja": {
    ...
    headlines: [
      "小さなチームから新しい現場メモが届いています。",
      "ページが進むたびに、新しい動きが見えてきます。",
      "ライブフィードに役立つ続報が追加されています。",
      "キューが動く間に、さらに多くのレポートが届きます。",
      "最後のプレビューページでもループが続きます。"
    ],
    summaries: [
      "Safari が更新とクリックを続ける間、フィードには新しい情報が入ります。",
      "次のページでは、ローンチ情報、製品メモ、ユーザーの反応を確認できます。",
      "繰り返しの更新とクリックで、一致するページを続けて閲覧できます。",
      "自動クリックごとに、フィード内の次の一致結果へ進みます。",
      "デモには、きれいに録画できるだけのページを用意しています。"
    ],
    stories: [
      "小さな製品チームがローンチチェックリストを共有",
      "予約ツールが確認画面をより速く改善",
      "クリエイターがライブフィードバックのメモを比較",
      "ダッシュボードが進行中のキュー変化を強調",
      "デザインチームが混み合うモバイル導線を整理",
      "新しいレポートが初期ユーザーの反応を追跡"
    ]
  },
  "ko": {
    ...
    headlines: [
      "작은 팀들의 현장 메모가 계속 도착합니다.",
      "페이지가 움직일수록 새로운 활동이 나타납니다.",
      "실시간 피드에 유용한 후속 소식이 더해집니다.",
      "대기열이 움직이는 동안 더 많은 보고가 들어옵니다.",
      "마지막 미리보기 페이지에서도 흐름이 계속됩니다."
    ],
    summaries: [
      "Safari가 새로고침과 클릭을 이어 가는 동안 피드에 새 소식이 들어옵니다.",
      "다음 페이지에서는 출시 소식, 제품 메모, 사용자 반응을 볼 수 있습니다.",
      "반복 새로고침과 클릭으로 일치하는 페이지를 계속 탐색할 수 있습니다.",
      "자동 클릭마다 피드의 다음 일치 결과로 이동합니다.",
      "데모에는 깔끔한 미리보기 녹화를 위한 충분한 페이지가 준비되어 있습니다."
    ],
    stories: [
      "작은 제품 팀이 출시 체크리스트를 공유",
      "예약 도구가 더 빠른 확인 화면을 추가",
      "크리에이터들이 실시간 피드백 메모를 비교",
      "대시보드가 활성 대기열의 변화를 강조",
      "디자인 팀이 복잡한 모바일 흐름을 단순화",
      "새 보고서가 초기 고객 반응을 추적"
    ]
  },
  "de-DE": {
  ...
  "ar-SA": {
    ...
    headlines: [
      "تحديث جديد يضيف ملاحظات ميدانية من فرق صغيرة.",
      "نشاط جديد يظهر بينما يستمر الموجز في التقدم.",
      "الموجز المباشر يضيف قصص متابعة مفيدة.",
      "تقارير جديدة تصل مع استمرار حركة القائمة.",
      "صفحة معاينة أخيرة توضّح استمرار التكرار."
    ],
    summaries: [
      "تصل تقارير جديدة بينما يواصل Safari تحريك الموجز تلقائياً.",
      "تعرض الصفحة التالية مزيداً من الإطلاقات وملاحظات المنتجات وتحديثات المستخدمين.",
      "يمكن للتحديث والنقر المتكررين متابعة الصفحات المطابقة تلقائياً.",
      "كل نقرة تلقائية تنتقل إلى النتيجة المطابقة التالية في الموجز.",
      "تحتفظ صفحة العرض بعدد كافٍ من الصفحات لتسجيل معاينة واضحة."
    ],
    stories: [
      "فريق منتج صغير يشارك قائمة فحص الإطلاق",
      "أداة حجز تضيف شاشات تأكيد أسرع",
      "المبدعون يقارنون ملاحظات جلسة تعليقات مباشرة",
      "لوحة معلومات تبرز تغيّرات القوائم النشطة",
      "فرق التصميم تبسّط مسار عمل مزدحم على الجوال",
      "تقرير جديد يتابع ردود فعل العملاء الأوائل"
    ]
  }
};
